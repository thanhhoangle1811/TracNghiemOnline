...
function chart_graph_resize() {
	"use strict";
	jQuery('.sc_graph').each(function(){
		var graph = jQuery(this);
		graph.find('canvas').width(0); 	
		var width = graph.width(); 			
		graph.find('canvas').width(width); 	
	});
}
					...
					$datasets.push(
						{
							...
							// Bar
							highlightFill    : 'rgba('+hex2rgb($currData.attr('data-fill-color')).red+','+hex2rgb($currData.attr('data-fill-color')).green+','+hex2rgb($currData.attr('data-fill-color')).blue+',0.8)',
							...
							fillColor        : 'rgba('+hex2rgb($currData.attr('data-fill-color')).red+','+hex2rgb($currData.attr('data-fill-color')).green+','+hex2rgb($currData.attr('data-fill-color')).blue+',0.8)',
